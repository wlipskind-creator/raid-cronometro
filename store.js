...
window.Store = (function () {
  ...
  function demoStore() {
    ...
    function seed() {
      ...
      return {
        clubs: { c1: { name: 'Club Hípico del Este', short: 'CHE', logo: '', col1: '#1E4FA3', col2: '#F2C200', col3: '#FFFFFF' }, c2: { name: 'Sociedad Criolla Los Horneros', short: 'SCLH', logo: '', col1: '#111111', col2: '#F5C400' } },
        races: {
