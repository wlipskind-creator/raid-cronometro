...
window.Store = (function () {
  ...
  function demoStore() {
    ...
    const subs = { race: [], races: [], clubs: [], staff: [], admins: [] };
    ...
    return {
      ...
      clearParticipants() { R().participants = []; save(); return Promise.resolve(); },
      ...
      deleteRace(id) { delete st.races[id]; save(); return Promise.resolve(); },
